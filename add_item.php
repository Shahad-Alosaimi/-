    ...
    if (empty($title) || empty($description) || empty($city)) {
        ...
        if (!$error) {
            $conn->query("INSERT INTO items
                (user_id, category_id, type, title, description, city, district, incident_date, image1, image2, image3)
                VALUES ($user_id, $category_id, '$type_post', '$title', '$description', '$city', '$district', '$inc_date',
    ...
    <div class="form-container" style="max-width:680px;">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea name="description" required placeholder="اوصفي الغرض بالتفصيل: اللون، الشكل، أي علامات مميزة..."></textarea>
            </div>
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:14px;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="district" placeholder="مثال: مبنى D، قرب المكتبة">
                </div>
            </div>
